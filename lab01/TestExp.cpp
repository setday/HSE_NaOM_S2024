...
{
  return adaptive_compare<float, ADAAI::Exp<float, M>, std::exp>( x ) and
         adaptive_compare<double, ADAAI::Exp<double, M>, std::exp>( x ) and
         adaptive_compare<long double, ADAAI::Exp<long double, M>, std::exp>( x );
}
...
bool exp_range_tests()
{
  ...
  std::cout << range_check<long double, exp_triple_check<M>>( -1000, 1000, 0.1, true ) << '\n';
